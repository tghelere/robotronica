      ...
      <div class="description">
        ...
        <span><?php echo $text_stock; ?></span>
          <?php if ($qtd_estoque > 0) {
            echo "<span class='verde'>" . $stock . "</span>";
          } else {
            echo "<span class='vermelho'>" . $stock . "</span>";
          }?>
      </div>

      <div class="pagseguro">
          <img src="catalog/view/theme/<?php echo $this->config->get('config_template');?>/image/pagseguro-todos.gif" alt="Formas de pagamento">          
        </div>
